import pandas as pd
import pytest
from detect_best_csp_savings_account import calc_apy_last_year
...
def test_calc_apy_last_year_duplicates():
    data = {
        'account_id': [1, 1, 1],
        'apy': [0.01, 0.02, 0.03],
...
def test_calc_apy_last_year_max_12_records():
    data = {
        ...
        'apy': [0.01 + i * 0.001 for i in range(18)] + [0.02 + i * 0.001 for i in range(18)],
